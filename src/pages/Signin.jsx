...
export default function Signin() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      localStorage.setItem("hgbc_admin_email", result.email);
      navigate("/admin/overview", { replace: true });
    } catch (error) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4 relative font-sans">
      {/* Background Pattern */}
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 p-8 text-center relative">
            ...
            <div className="relative z-10">
              ...
              <p className="text-blue-100 text-sm">Sign in to manage members data</p>
            </div>
            {/* Decorative Elements */}
          ...
          <div className="p-8">
            <form onSubmit={handleSubmit} className="space-y-6">
              {errors.form && (
                <div className="bg-red-50 text-red-700 border border-red-200/50 p-4 rounded-xl text-sm font-medium">
                  {errors.form}
                </div>
              )}
